...
write.csv(epic_full_25, file="path/to/epic_all_mgm.csv")
write.csv(epic_full, file="path/to/epic_all_mgm.csv", quote = F, row.names = F)
all_info <- epic_all$analyses$all$table
all_info <- all_info[common_sites,]
dim(all_info)
all_info$cpg <- as.character(rownames(all_info))
write.csv(all_info, file="path/to/epic_all_mgm_allinfo.csv", quote = F, row.names = F)
...
write.csv(four50_full_25, file="path/to/four50_all_mgm.csv")
write.csv(four50_full, file="path/to/four50_all_mgm.csv", quote = F, row.names = F)
all_info <- four50_all$analyses$all$table
all_info <- all_info[common_sites,]
dim(all_info)
all_info$cpg <- as.character(rownames(all_info))
write.csv(all_info, file="path/to/four50_all_mgm_allinfo.csv", quote = F, row.names = F)
